        ...
        <div class="py-md-4 py-5 bg-secondary rounded-3">
            <div class="col-sm-10 col-11 d-flex flex-md-row flex-column align-items-center justify-content-between mx-auto px-0">
                <div class="order-md-1 order-2 text-md-start text-center" style="max-width: 524px;">
                    ...
                    <router-link class="btn btn-lg btn-primary rounded-pill w-sm-auto w-100" to="/job-board-contacts">Contact us</router-link>
                </div>
                <img class="order-md-2 order-1 ms-md-4" src="@/assets/img/job-board/illustrations/mail.svg" alt="Illustration">
            </div>
        </div>
    </section>
</template>