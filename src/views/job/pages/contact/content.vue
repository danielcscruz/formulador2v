<template>
    ...
    <div class="row gy-4">
            ...
            <div class="card border-0 bg-secondary p-md-3 p-1">
                <div class="card-body">
                    ...
                    <div class="mb-md-5 mb-4">
                        <a class="nav-link fw-normal d-flex align-items-start mb-3 p-0" href="mailto:example@email.com">
                            <i class="fi-mail mt-1 me-2 pe-1 text-primary"></i>example@email.com
                        </a>
                        <a class="nav-link fw-normal d-flex align-items-start mb-3 p-0" href="tel:4065550120">
                            <i class="fi-device-mobile mt-1 me-2 pe-1 text-primary"></i>(406) 555-0120
                        </a>
                        <a class="nav-link fw-normal d-flex align-items-start mb-3 p-0" href="javascript:void(0);">
                            <i class="fi-map-pin mt-1 me-2 pe-1 text-primary"></i>4140 Parker Rd. Allentown, <br> New Mexico 31134
                        </a>
                        <span class="nav-link fw-normal d-flex align-items-start mb-3 p-0">
                            <i class="fi-clock mt-1 me-2 pe-1 text-primary"></i>Mon – Fri: 10:00 am – 20:00 pm
                        </span>
                    </div>
                    <h3 class="h6 mb-1">Follow us:</h3>
                    <a class="btn btn-icon btn-light-primary btn-xs rounded-circle shadow-sm mt-2 me-2" href="javascript:void(0);">
        ...
        <div class="col-md-7 offset-lg-1">
            <h2 class="h4 mb-4 pb-md-2">Perhaps you can find an answer to your question here:</h2>
            <div class="mb-md-4 mb-3 fs-sm">
                <h6 class="mb-md-3 mb-2 fs-base">Should I apply for a job even if I don't have the specified experience?</h6>
            ...
            <div class="mb-md-4 mb-3 fs-sm">
                <h6 class="mb-md-3 mb-2 fs-base">What are the most important things to include in my resume?</h6>
            ...
            <div class="mb-md-4 mb-3 fs-sm">
                <h6 class="mb-md-3 mb-2 fs-base">How long should I make my cover letter and/or resume?</h6>
            ...
            <div class="mb-md-4 mb-3 fs-sm">
                <h6 class="mb-md-3 mb-2 fs-base">Will our data be private and safe?</h6>
            ...
            <div class="pt-md-3 pt-2"><router-link class="btn btn-primary rounded-pill" to="/job-board-help-center">Go to help center<i class="fi-chevron-right ms-2"></i></router-link></div>
        </div>
    </div>
</template>