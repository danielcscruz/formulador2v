    ...
    <div class="row justify-content-center pb-sm-2">
        <div class="col-lg-11 col-xl-10">
            ...
            <div class="text-center pb-4 mb-3">
                ...
                <p class="mb-4">
                    Save time by uploading a resume to prefill some of the fields below. Please, use PDF
                    format.
                </p>
            ...
            <div class="bg-light rounded-3 p-4 p-md-5 mb-3">
                ...
                <div class="pb-4 mb-2">
                    ...
                    <a class="collapse-label collapsed d-inline-block fs-sm fw-bold text-decoration-none pt-2" href="#showMoreSocials" data-bs-toggle="collapse" data-bs-label-collapsed="Show more" data-bs-label-expanded="Show less" role="button" aria-expanded="false" aria-controls="showMoreSocials"><i class="fi-arrow-down me-2"></i></a>
                </div>
            ...
            <div class="d-flex flex-column flex-sm-row bg-light rounded-3 p-4 px-md-5">
                <router-link class="btn btn-primary btn-lg rounded-pill ms-sm-auto" to="/job-board-post-resume-2">Next step<i class="fi-chevron-right fs-sm ms-2"></i></router-link>
            </div>
        </div>
    </div>
</template>
