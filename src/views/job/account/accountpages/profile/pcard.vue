        ...
        <div class="d-flex align-items-start justify-content-between pb-4 mb-2">
            <div class="d-flex align-items-start">
                <div class="position-relative flex-shrink-0">
                    <img class="rounded-circle" src="@/assets/img/avatars/37.png" width="100" alt="Annette Black" />
                    <button class="btn btn-icon btn-light btn-xs rounded-circle shadow-sm position-absolute end-0 bottom-0" type="button" data-bs-toggle="tooltip" title="Change image">
                ...
                <div class="ps-3 ps-sm-4">
                    ...
                    <ul class="list-unstyled fs-sm mb-0">
                        <li class="d-flex text-nav text-break">
                            <i class="fi-mail opacity-60 mt-1 me-2"></i><span>annette_black@email.com</span>
                        </li>
                        <li class="d-flex text-nav text-break">
                            <i class="fi-phone opacity-60 mt-1 me-2"></i><span>(302) 555-0107</span>
                        </li>
                    </ul>
                </div>
            </div>
            <router-link class="nav-link p-0 d-none d-md-block" to="/signin-light"><i class="fi-logout mt-n1 me-2"></i>Sign out</router-link>
        </div>
        <!-- Account menu--><a class="btn btn-outline-primary btn-lg rounded-pill w-100 d-md-none" data-bs-target="#account-nav" data-bs-toggle="collapse"><i class="fi-align-justify me-2"></i>Account Menu</a>
        <div class="collapse d-md-block" id="account-nav">
            <ul class="nav nav-pills flex-column flex-md-row pt-3 pt-md-0 pb-md-4 border-bottom-md">
                <li class="nav-item mb-md-0 me-md-2 pe-md-1">
                    <router-link class="nav-link active" to="/job-board-account-profile" aria-current="page">
                        <i class="fi-settings mt-n1 me-2 fs-base"></i>Profile Settings</router-link>
                </li>
                <li class="nav-item mb-md-0 me-md-2 pe-md-1">
                    <router-link class="nav-link" to="/job-board-account-my-resumes"><i class="fi-file mt-n1 me-2 fs-base"></i>My Resumes</router-link>
                </li>
                <li class="nav-item mb-md-0 me-md-2 pe-md-1">
                    <router-link class="nav-link" to="/job-board-account-saved-jobs"><i class="fi-heart mt-n1 me-2 fs-base"></i>Saved Jobs</router-link>
                </li>
                <li class="nav-item mb-md-0">
                    <router-link class="nav-link" to="/job-board-account-notifications"><i class="fi-bell mt-n1 me-2 fs-base"></i>Notifications</router-link>
                </li>
                <li class="nav-item d-md-none">
                    <router-link class="nav-link" to="/signin-light"><i class="fi-logout mt-n1 me-2 fs-base"></i>Sign Out</router-link>
                </li>
            </ul>
        </div>
        <!-- Authorization info-->
                ...
                <div class="border rounded-3 p-3" id="auth-info">
                    ...
                    <div class="border-bottom pb-3 mb-3">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div data-bs-toggle="tooltip" title="Edit">
                                <a class="nav-link py-0" data-bs-target="#email-collapse" data-bs-toggle="collapse"><i class="fi-edit"></i></a>
                            </div>
                        </div>
                    ...
                    <div>
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div data-bs-toggle="tooltip" title="Edit">
                                <a class="nav-link py-0" data-bs-target="#password-collapse" data-bs-toggle="collapse"><i class="fi-edit"></i></a>
                            </div>
                        </div>
                ...
                <div class="border rounded-3 p-3" id="personal-details">
                    ...
                    <div class="border-bottom pb-3 mb-3">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div data-bs-toggle="tooltip" title="Edit">
                                <a class="nav-link py-0" data-bs-target="#fn-collapse" data-bs-toggle="collapse"><i class="fi-edit"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="border-bottom pb-3 mb-3">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div data-bs-toggle="tooltip" title="Edit">
                                <a class="nav-link py-0" data-bs-target="#gender-collapse" data-bs-toggle="collapse"><i class="fi-edit"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="border-bottom pb-3 mb-3">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div data-bs-toggle="tooltip" title="Edit">
                                <a class="nav-link py-0" data-bs-target="#birth-collapse" data-bs-toggle="collapse"><i class="fi-edit"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="border-bottom pb-3 mb-3">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div data-bs-toggle="tooltip" title="Edit">
                                <a class="nav-link py-0" data-bs-target="#phone-collapse" data-bs-toggle="collapse"><i class="fi-edit"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="border-bottom pb-3 mb-3">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div data-bs-toggle="tooltip" title="Edit">
                                <a class="nav-link py-0" data-bs-target="#address-collapse" data-bs-toggle="collapse"><i class="fi-edit"></i></a>
                            </div>
                        </div>
                    ...
                    <div>
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div data-bs-toggle="tooltip" title="Edit">
                                <a class="nav-link py-0" data-bs-target="#socials-collapse" data-bs-toggle="collapse"><i class="fi-edit"></i></a>
                            </div>
                        </div>
                        <div class="collapse mt-3" id="socials-collapse" data-bs-parent="#personal-details">
                            ...
                            <div class="collapse" id="showMoreSocials">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <div class="btn btn-icon btn-light btn-xs shadow-sm rounded-circle pe-none flex-shrink-0 me-3">
                                        <i class="fi-behance text-body"></i>
                                    </div>
                                    <input class="form-control" type="text" data-bs-binded-element="#behance-value" placeholder="Your Behance account" />
                                </div>
                            </div>
                            <a class="collapse-label collapsed d-inline-block fs-sm fw-bold text-decoration-none pt-2 pb-3" data-bs-target="#showMoreSocials" data-bs-toggle="collapse" data-bs-label-collapsed="Show more" data-bs-label-expanded="Show less" role="button" aria-expanded="false" aria-controls="showMoreSocials">
                ...
                <div class="border rounded-3 p-3" id="account-settings">
                    ...
                    <div class="border-bottom pb-3 mb-3">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div data-bs-toggle="tooltip" title="Edit">
                                <a class="nav-link py-0" data-bs-target="#type-collapse" data-bs-toggle="collapse">
                                    <i class="fi-edit"></i>
                                </a>
                            </div>
                        </div>
                        <div class="collapse" id="type-collapse" data-bs-parent="#account-settings">
                            <select class="form-select mt-3" data-bs-binded-element="#type-value">
                                ...
                                <option value="Job seeker (looking for a job)" selected>
                    ...
                    <div>
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div data-bs-toggle="tooltip" title="Edit">
                                <a class="nav-link py-0" data-bs-target="#auth-collapse" data-bs-toggle="collapse"><i class="fi-edit"></i></a>
                            </div>
                        </div>
            ...
            <div class="col-lg-9 offset-lg-3">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <button class="btn btn-link btn-sm px-0" type="button">
                        <i class="fi-trash me-2"></i>Delete account
                    </button>
                </div>
            </div>
        </div>
