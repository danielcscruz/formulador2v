    ...
    <main class="page-wrapper">
        ...
        <div class="container-fluid d-flex h-100 align-items-center justify-content-center py-4 py-sm-5">
            <div class="card card-body" style="max-width: 940px">
                <a class="position-absolute top-0 end-0 nav-link fs-sm py-1 px-2 mt-3 me-3" href="javascript:void(0)" onclick="window.history.go(-1); return false;"><i class="fi-arrow-long-left fs-base me-2"></i>Go back</a>
                <div class="row mx-0 align-items-center">
                    <div class="col-md-6 border-end-md p-2 p-sm-5">
                        ...
                        <div class="mt-4 mt-sm-5">
                            Don't have an account? <router-link to="/signup-light">Sign up here</router-link>
                        </div>
                    </div>
